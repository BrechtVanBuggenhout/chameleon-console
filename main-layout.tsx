      ...
      <aside className="flex w-60 flex-shrink-0 flex-col border-r border-gray-200 bg-white">
        ...
        <div className="flex items-center gap-2.5 border-b border-gray-100 px-4 py-4">
          ...
          <div className="min-w-0">
            <p className="text-sm font-semibold text-gray-900">Chameleon</p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-100 p-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-2 rounded-md px-2.5 py-2 text-xs text-gray-400 hover:text-gray-600"
          >
            <span>↗</span>
            chameleon-data.com
          </a>
